...
public class PortalAuth {
    ...
    /**
     * PortalAuth is still valid if it hasn't reached 300 seconds before the
     * expiration time
     * 
     * @return
     */
    ...
    /**
     * PortalAuth can be refreshed if it hasn't reached the expiration time (minus 2
     * seconds)
     * 
     * @return
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(authResponse, portalAuth.authResponse)
                && Objects.equals(authReponseTime, portalAuth.authReponseTime);
    }
