...
public class WebController implements ErrorController {
    ...
    public ModelAndView launchWorkshop(@PathVariable(name = "workshop") String workshopUID, HttpServletRequest request,
    ...
    public ModelAndView workshopInfo(@PathVariable(name = "workshop") String workshopUID, HttpServletRequest request,
            Map<String, Object> model) {
